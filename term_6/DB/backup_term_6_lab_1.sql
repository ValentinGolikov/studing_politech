...
\restrict tp1uiaW8Q2718n20p7KUS966PlvqWO1DBz3aMAGTZSpfcHHOvCtHqjDcIMtxi6H
...
43	2025-10-27 13:30:00	\N	1	5
48	2025-12-02 21:38:21.123557	\N	5	5
49	2025-12-02 21:39:33.408882	\N	4	5
29	2026-01-10 08:00:00	2025-10-28 14:00:00	11	8
17	2025-10-30 15:40:00	\N	2	6
\.
...
COPY public.test (id, name, value, description) FROM stdin;
4	item4	400	desc4
5	item5	500	desc5
3	item3	777	desc3
2	item2	250	desc2
...
SELECT pg_catalog.setval('public.auto_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.auto_personal_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.journal_id_seq', 52, true);
...
\unrestrict tp1uiaW8Q2718n20p7KUS966PlvqWO1DBz3aMAGTZSpfcHHOvCtHqjDcIMtxi6H
